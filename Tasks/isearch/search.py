...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while True:
        ...
        action_list = popped_element[1]
        parent_cost = popped_element[2]
        if problem.isGoalState(node):    
            ...
            if node not in visited_nodes:    
                ...
                for successor in successors:
                    ...
                    full_path = action_list + [child_action]    
                    full_cost = parent_cost + child_cost    
                    fringe.push((child_node, full_path, full_cost), full_cost + heuristic(child_node, problem))    
