...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.visitedCorner = {}
        for corner in self.corners:
            self.visitedCorner[corner] = False
    ...
    def getStartState(self):
        ...
        startNode = (self.startingPosition, self.visitedCorner)
        return startNode
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        _, currVisitedCorner = state
        for corner in self.corners:
            if currVisitedCorner[corner] == False:
                return False
...
def cornersHeuristic(state, problem: CornersProblem):
    ...
    if len(unvisitedCorners) == 0:
        ...
        for corner in unvisitedCorners:
            distances.append(util.manhattanDistance(currPos, corner))
...
def foodHeuristic(state, problem):
    ...
    #         distancesFromFood.append(util.manhattanDistance(position, food))
    #     return max(distancesFromFood)
